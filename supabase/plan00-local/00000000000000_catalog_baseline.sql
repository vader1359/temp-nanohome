-- Local-only recovery copy of c680c8f's historical catalog baseline.
-- This file is not a tracked migration and must never be applied remotely.
-- Later tracked migrations add columns, indexes, policies, and functions.
