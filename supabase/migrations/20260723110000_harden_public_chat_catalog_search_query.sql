-- Keep the already-deployed public chat search signature while bounding direct
-- anonymous RPC input inside PostgreSQL. The client also applies the same
-- limit, but this guard protects callers that bypass the application.
