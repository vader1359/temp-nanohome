import { runAmisInventoryBaseline } from "@/lib/amis/inventory-sync";
...
async function handle(request: Request): Promise<Response> {
  ...
  return Response.json(safeResult(await runAmisInventoryBaseline()));
}

function safeResult(result: Awaited<ReturnType<typeof runAmisInventoryBaseline>>) {
  return {
