...
import { getDesignerByAirtableId, getDesignerBySlug, getDesigners, getProductsByDesignerAirtableId, getProductsByDesignerSlug, searchDesigners } from "./designers";

describe("designers exports", () => {
  it("imports every designer query export", () => {
    expect(getDesigners).toBeTypeOf("function");
    expect(searchDesigners).toBeTypeOf("function");
